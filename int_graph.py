...
# screen = tk.Canvas(racine , width= 2000, height= 1000 , bg= "white", scrollregion=(1000,1000,500,500))
# hbar=tk.Scrollbar(racine,orient= "horizontal")
# hbar.pack(side= "bottom",fill="x")
# hbar.config(command=screen.xview)
# vbar=tk.Scrollbar(racine,orient="vertical")
# vbar.pack(side="right",fill="y")
# screen.grid(column = 1, row = 0, rowspan = 20)
...
menu = Button(root, text=" creation arbre")
menu.pack(side= 'top', )
frame.pack(expand=True, fill=BOTH) #.grid(row=0,column=0)
canvas=Canvas(frame,bg='#FFFFFF',width=1000,height=1000,scrollregion=(0,0,500,500))
canvas.create_line((2,2), (998,998))
